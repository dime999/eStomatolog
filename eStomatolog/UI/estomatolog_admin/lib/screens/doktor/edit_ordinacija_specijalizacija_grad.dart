...
class EditDoctorSettingsScreen extends StatefulWidget {
  final int korisnikId;
  final int doktorId;

  const EditDoctorSettingsScreen(
      {super.key, required this.korisnikId, required this.doktorId});

  @override
  _EditDoctorSettingsScreenState createState() =>
      _EditDoctorSettingsScreenState();
}

class _EditDoctorSettingsScreenState extends State<EditDoctorSettingsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Uredi dodatne informacije o doktoru'),
        centerTitle: true,
      ),
